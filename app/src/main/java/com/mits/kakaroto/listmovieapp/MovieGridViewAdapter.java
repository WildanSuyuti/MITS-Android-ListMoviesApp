...
public class MovieGridViewAdapter extends RecyclerView.Adapter<MovieGridViewAdapter.MyViewHolder> {
    ...
    public MovieGridViewAdapter(List<Movie> dataset){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_grid_movie, parent, false);
